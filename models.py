...
class Application(models.Model):
    ...
    state = models.IntegerField(default=1,choices=((-1,'未通过'),(0,'待分配'),(1,'院级审核中'),(2,'校级审批中'),(3,'负责人审核中'),(4,'申请完成')))
...
class Administration(models.Model):
    ...
    countersign1 = models.CharField(max_length=100,null=True,default=None)
    ...
    aall = models.IntegerField(default=1)
    ahas = models.IntegerField(default=0)

    sign = models.CharField(max_length=100, null=True, default=None)
...
class message(models.Model):
    ...
    missionnum = models.IntegerField(default=0, choices=((0, '分配'), (1, '院级审核'), (2, '校级审批'), (3, '负责人审核')))
